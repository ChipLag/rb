...
gSrr:NewButton("[NEW] SRR Script", "Insane Slap Royale Remake Script", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ChipLag/rb/main/srr/srr_hub.lua",true))() 
end)
