...
local gSrr = games:NewSection("[NEW] Slap Royale Remake")
gSrr:NewButton("[NEW] UIs", "Show Admin UIs!", function()
        loadstring(game:HttpGet("https://raw.githubusercontent.com/ChipLag/rb/main/srruis.lua",true))() 
end)
